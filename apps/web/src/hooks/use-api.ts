...
// ============ Student Journey Hooks ============
// Student journey hooks are in a separate file: use-student-journey.ts
export {
  // Milestone hooks
  useMilestones,
  useMilestone,
  ...
  useMyJourneyStats,
  useCompareSemesters,
  useYearOverYearProgress,
  useMyYearOverYearProgress,
  // Dashboard hooks
  useJourneyDashboard,
  ...
  type YearProgress,
  type YearOverYearProgress,
  type JourneyDashboard,
  type CreateMilestoneInput,
  type UpdateMilestoneInput,
  type QueryMilestonesParams,
  type QuerySnapshotsParams,
  type TimelineFilterParams,
  type GenerateSnapshotInput,
  type BulkGenerateSnapshotsInput,
  type ExportJourneyInput,
} from './use-student-journey';

// ============ Alumni Hooks ============
// Alumni hooks are in a separate file: use-alumni.ts
export {
  // Profile hooks
  useAlumniDirectory,
  useDirectoryFilters,
  ...
  useLogMeeting,
  useRateMentorshipAsStudent,
  useRateMentorshipAsAlumni,
  useMyMentorStats,
  // Contribution hooks
  ...
  type RespondMentorshipInput,
  type RateMentorshipInput,
...
// ============ Accreditation Hooks ============
// Accreditation hooks are in a separate file: use-accreditation.ts
export {
  // Metric hooks
  useAccreditationMetrics,
  useAccreditationMetric,
  useCreateMetric,
  useUpdateMetric,
  useDeleteMetric,
  useFrameworkMetrics,
  // Value hooks
  useAccreditationValues,
  useCreateValue,
  useUpdateValue,
  useBulkUpdateValues,
  useVerifyValue,
  // Report hooks
  useAccreditationReports,
  useAccreditationReport,
  useCreateReport,
  useUpdateReport,
  useSubmitReport,
  useDeleteReport,
  ...
  useYearComparison,
  useAllFrameworkSummaries,
  // Seeding & Calculation hooks
  useSeedFramework,
  useSeedAllFrameworks,
  useCalculateFramework,
  // Utility functions
  getNaacGrade,
  getNaacGradeColor,
  getTrendIcon,
  ...
  type QueryValuesParams,
  type QueryReportsParams,
  type CreateMetricInput,
  type UpdateMetricInput,
  type CreateValueInput,
  type UpdateValueInput,
  type BulkUpdateValuesInput,
  type CreateReportInput,
  type UpdateReportInput,
  type SeedFrameworkInput,
  type CalculateFrameworkInput,
} from './use-accreditation';

// ============ Face Recognition Hooks ============
// Face recognition hooks are in a separate file: use-face-recognition.ts
export {
  // Query keys
  faceRecognitionKeys,
